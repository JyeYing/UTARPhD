...
def get_admm_sol(libdata):
    ...
    def func_check(t, x):
        ...
        y1 = lambda_T[0,1]*x[0] #lambda_T[0,0] + lambda_T[0,2]*x[1] + lambda_T[0,3]*(x[0]**2) + lambda_T[0,4]*(x[1]**2) + lambda_T[0,5]*(x[0]*x[1]) 
        y2 = lambda_T[1,1]*x[0] #lambda_T[1,0]+ lambda_T[1,2]*x[1] + lambda_T[1,3]*(x[0]**2) + lambda_T[1,4]*(x[1]**2) + lambda_T[1,5]*(x[0]*x[1])
               
        return np.array([y1, y2])
    
    sol_lambda = scint.solve_ivp(fun=func_check, t_span=(0,10), y0=[-0.1,0.3], method="RK45", t_eval=np.linspace(0,10,200))
...
def get_LU_sol(libdata):
    ...
    def func_check(t, x):
        ...
        y1 =  lams[0,1]*x[0] #lams[0,0] + lams[0,2]*x[1] + lams[0,3]*(x[0]**2) + lams[0,4]*(x[1]**2) + lams[0,5]*(x[0]*x[1]) 
    ...
    sol_LU = scint.solve_ivp(fun=func_check, t_span=(0,10), y0=[-0.1,0.3], method="RK45", t_eval=np.linspace(0,10,200))
...
def get_lasso_sol(libdata):
    ...
    def func_check(t, x):
        ...
        #---------------sparse----------
        y1 =  w[0,0]*x[0] #w[1,0]+ w[1,0]*x[1] + w[2,0]*(x[0]**2) + w[3,0]*(x[1]**2) + w[4,0]*(x[0]*x[1]) 
    ...
    sol_sparse = scint.solve_ivp(fun=func_check, t_span=(0,10), y0=[-0.1,0.3], method="RK45", t_eval=np.linspace(0,10,200))
