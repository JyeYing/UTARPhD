...
# Configuration
t0, t1, gap= 0, 1, 100  #step size 0.01
sampling = 60
y0=[0,1]
...
def visualize(data):
    ...
    ax1.legend(loc='upper left')
    plt.show()
    fig.savefig('simple_train.png', dpi=300)
    ...
    ax2.legend(loc='upper left')
    plt.show()
    fig.savefig('simple_non.png', dpi=300)

def save_output(data, fname="simple2.pkl"):
...
def main():
    ...
    visualize(data)
    save_output(data, fname="simple2.pkl")
