...
def visualize(var_data):
    ...
    fig.savefig('logloss_pinn.png', dpi=300)
    ...
    fig.savefig('simple_ipinnsLoss.png', dpi=300)

    #plot trajectory of coupled first order ODE (especially on other time t)
    

def save_output(var_data, fname="simple2_sparse.pkl"):
...
def main():
    ...
    save_output(var_data, fname="simple2_sparse.pkl")
