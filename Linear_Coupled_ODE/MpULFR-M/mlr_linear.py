...
# Solve the true ODE
# -------------------------
sol = solve_ivp(coupled_ode, t_span, [0, 1], dense_output=True)
...
# -------------------------
mlr_sol = solve_ivp(mlr_ode, t_span, [0, 1], t_eval=t_eval)
...
plt.legend()
#plt.axis('equal')
plt.savefig("linear_mlr.png", dpi=300, bbox_inches="tight")
plt.show()
#plt.savefig('simple_mlr.png', dpi=300)
