"""
Created on Apr 16 09:02:58 2026
...
def visualize(data):
    ...
    # Display the plot
    plt.show()
    fig.savefig('harmonic_num.png', dpi=300)
    ...
    # Plot the trajectory
    ax7.plot(t,numerical_sol.y[0,:],'x' , label='Data(RK45)') #2 #for solution, y(t)
    ...
    # Display the plot
    plt.show()
    fig.savefig('harmonic.png', dpi=300)
    
    #if plot numerical_sol.y[1,:], then will get its derivative, y'(t) = - cos(t)

def save_output(data, fname="harmonic.pkl"):
...
def main():
    ...
    visualize(data)
    save_output(data, fname="harmonic.pkl")
