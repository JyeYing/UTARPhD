...
def make_data():    
    with open ('p_nonlinear.pkl','rb') as f:
        pdata = pickle.load(f)
...
def visualize(libdata):
    ...
    #fig.suptitle("RK45 vs IPINNs_nonlinear", fontsize=12)
    ...
    #fig.suptitle("SIPINNs_nonlinear", fontsize=12)
