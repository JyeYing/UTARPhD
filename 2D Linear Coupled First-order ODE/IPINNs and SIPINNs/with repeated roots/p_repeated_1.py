# -*- coding: utf-8 -*-
"""
Created on Sun Mar 23 16:21:55 2025
...
def visualize(data):
    ...
    fig.suptitle("x(t) and y(t) for data(repeated)", fontsize=12)
...
def save_output(libdata, fname="p_repeated_1.pkl"):
...
def main():
    ...
    visualize(libdata)
    save_output(libdata, fname="p_repeated_1.pkl")
